...
const DocumentViewer = ({ document: docData, pageNumber, setPageNumber, numPages, setNumPages }) => {
    ...
    const saveProgress = async () => {
        ...
        try {
            // Make sure pageNumber is a valid integer
            const progressValue = parseInt(pageNumber, 10);
            
            // Log what's being sent
            console.log(`Sending progress update: ${progressValue} for document ID: ${docData.document_id}`);
